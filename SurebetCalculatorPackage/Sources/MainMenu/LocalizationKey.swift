...
enum MainMenuLocalizationKey: String {
    ...
    case menuDisableAdsTitle = "menu_disable_ads_title"
    case menuDisableAdsSubtitle = "menu_disable_ads_subtitle"
    case menuDisableAdsDescription = "menu_disable_ads_description"
